...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  Init();
  BLUENRG_PRINTF("INITIALIZATIONS COMPLETE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\r\n");
  SM_Init(&huart2);
  keyboard_Init(&huart2);
  // BLE Init
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, SPI_CS_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_CS_Pin LD2_Pin */
  GPIO_InitStruct.Pin = SPI_CS_Pin|LD2_Pin;
