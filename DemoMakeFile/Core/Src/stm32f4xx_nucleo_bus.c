...
/** @defgroup STM32F4XX_NUCLEO_BUS_Private_FunctionPrototypes  BUS Private
 * Function
 * @{
 */
...
/** @defgroup STM32F4XX_NUCLEO_LOW_LEVEL_Private_Functions STM32F4XX_NUCLEO LOW
 * LEVEL Private Functions
 * @{
 */

/** @defgroup STM32F4XX_NUCLEO_BUS_Exported_Functions STM32F4XX_NUCLEO_BUS
 * Exported Functions
 * @{
 */
